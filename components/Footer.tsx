    ...
    <footer className="text-center bg-gray-900 text-white w-screen block">
      <div className="container px-6 pt-6 flex flex-col items-center max-w-2xl w-full mx-auto">
        <div className="flex justify-center mb-6 text-white">
          {/* Twitter */}
          { siteConfig.twitterUrl && (<a href={ siteConfig.twitterUrl }>
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fab"
          ...
          {/* Instagram */}
          {siteConfig.instagramUrl && (<a href={ siteConfig.instagramUrl }>
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fab"
          ...
          {/* Github */}
          { siteConfig.githubUrl && ( <a href={ siteConfig.githubUrl }>
            <svg
              aria-hidden="true"
              focusable="false"
              data-prefix="fab"
